...
const Blog = () => {
  return (
    <div>
      ...
      <h2 className="font-semibold">Inline, inline-block, block?</h2>
      <h2 className="underline">Inline:</h2>
      <h2>
